...
class checkpoint():
    def __init__(self, args):
        ...
        os.makedirs(self.get_path('results-{}'.format(args.data_train)), exist_ok=True)
    ...
    def plot_psnr(self, epoch):
        ...
        for idx_data, d in enumerate(self.args.data_train):
    ...
    def save_results(self, name, filename, save_list, scale):
        if self.args.save_results:
            ...
            for v, p in zip(save_list, postfix):
                ...
                #torch.save(tensor_cpu,'{}{}.pth'.format(filename, p))
